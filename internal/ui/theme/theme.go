...
var (
	...
	AddedBg    = lipgloss.Color("#0c1f10") // GitHub-subtle dark-green tint for added rows
	DeletedBg  = lipgloss.Color("#1f0d0c") // GitHub-subtle dark-red tint for deleted rows
